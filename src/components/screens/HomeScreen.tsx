...
export default function HomeScreen({ navigate }: HomeScreenProps) {
  return (
    <div className="bg-white min-h-full">
      {/* Header */}
      <div className="p-4 lg:px-8 lg:py-6 flex justify-between items-center border-b border-gray-100">
      ...
      <div className="p-6 lg:px-12 lg:py-8 max-w-6xl mx-auto space-y-8 lg:space-y-12">
        ...
        <section className="space-y-4 lg:space-y-6">
          <h2 className="text-2xl lg:text-3xl font-semibold">Comment ça marche ?</h2>
          
          <div className="max-w-2xl">
            {/* Pour ceux qui CHINENT */}
            <div className="space-y-3 lg:space-y-4 p-6 bg-cyan-50 rounded-xl border border-cyan-100">
              <h3 className="font-medium text-lg lg:text-xl">Pour ceux qui CHINENT (Acheteurs)</h3>
              
              <div className="space-y-3">
                <div className="flex gap-3">
                  <div className="w-8 h-8 rounded-full bg-cyan-500 text-white flex items-center justify-center font-medium flex-shrink-0">1</div>
                  <div>
                    <p className="font-medium">Repère</p>
                    <p className="text-sm text-gray-600">Regarde sur l'app les articles dispos dans le bus.</p>
                  </div>
                </div>
                
                <div className="flex gap-3">
                  <div className="w-8 h-8 rounded-full bg-cyan-500 text-white flex items-center justify-center font-medium flex-shrink-0">2</div>
                  <div>
                    <p className="font-medium">Réserve</p>
                    <p className="text-sm text-gray-600">Bloque l'article gratuitement via le 'Click & Try'.</p>
                  </div>
                </div>
                
                <div className="flex gap-3">
                  <div className="w-8 h-8 rounded-full bg-cyan-500 text-white flex items-center justify-center font-medium flex-shrink-0">3</div>
                  <div>
                    <p className="font-medium">Essaie</p>
                    <p className="text-sm text-gray-600">Viens au bus, passe en cabine et repars avec ton look.</p>
                  </div>
                </div>
              </div>
            </div>
